...
const AdminPanel = () => {
  ...
  const renderMainContent = () => {
    switch (activeTab) {
      case 'dashboard':
        return <DashboardStats stats={dashboardStats} propertiesCount={properties.length} onTabChange={setActiveTab} />;
      case 'properties':
        return (
  ...
  return (
    <div className="h-screen bg-[#F5F6FA] flex font-sans overflow-hidden">
      ...
      />
      <div className="flex-1 md:ml-72 flex flex-col h-screen min-w-0 w-full overflow-hidden">
        <AdminHeader
          ...
          <Suspense fallback={
            <div className="space-y-8 animate-pulse">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100/50 shadow-sm space-y-4">
              ...
              {/* Large Content Area */}
              <div className="bg-white p-8 rounded-2xl border border-gray-100/50 shadow-sm space-y-6">
